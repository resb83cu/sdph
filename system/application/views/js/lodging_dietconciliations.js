...
Ext.onReady(function() {
	...
	var p = new Ext.Panel({
        title: 'Hospedaje -> Conciliar Dieta',
        collapsible:false,
    ...
    Conciliations.conciliationsDataProxy = new Ext.data.HttpProxy({
        url: baseUrl+'index.php/lodging/lodging_dietconciliations/setDataGrid',
        method: 'POST'
    });
        ...
        tbar:[{text:'Conciliar',
	            ...
	            handler: function(){
							...
							for (var i = 0, len = array.length; i < len; i++) {
						        Ext.Ajax.request({
								   url: baseUrl+'index.php/lodging/lodging_dietconciliations/insertBill/'+array[i].get('request_id')+'/'+Ext.getCmp('bill_number').getValue(),
								   method: 'GET',
        ...
        items: [{
            ...
            items:[{
		      ...
		      items:[	new Ext.form.ComboBox({
				            ...
				            listeners: {
								'blur': function(){
									var flag = dataStoreCafeteria.findExact( 'cafeteria_id', Ext.getCmp('filter_hotel_id').getValue());
						    		if (flag == -1){
						    			Ext.Msg.alert('Valor Inv&aacute;lido', 'Debe seleccionar un valor de la lista y no introducir un dato err&oacute;neo.');
    ...
    */
	...
	function update_ventana(id){
	   ...
	   var updateForm = new Ext.FormPanel({
		    ...
		    updateForm.addButton({
		        ...
		        handler : function() {
		            updateForm.getForm().submit({
		                url : baseUrl+'index.php/lodging/lodging_dietconciliations/insert',
	    	...
	    	var updateWindow;
			if (id > 0){
				updateForm.load({url:baseUrl+'index.php/lodging/lodging_dietconciliations/getById/'+id});
			}
