            ...
            items: [
                {
                    ...
                    listeners: {
                        'blur': function () {
                            ...
                            if (flag == -1 && Ext.getCmp('frm_province_id').getValue() != '') {
                                ...
                                new Ext.form.ComboBox({
                                    ...
                                    listeners: {
                                        'blur': function () {
                                            ...
                                            if (flag == -1 && Ext.getCmp('frm_motive_id').getValue() != '') {
                                                Ext.Msg.alert('Valor Inv&aacute;lido', 'Debe seleccionar un valor de la lista y no introducir un dato err&oacute;neo.');
                                ...
                                new Ext.form.ComboBox({
                                    ...
                                    listeners: {
                                        'blur': function () {
                                            ...
                                            if (flag == -1 && Ext.getCmp('frm_center_id').getValue() != '') {
                                                Ext.Msg.alert('Valor Inv&aacute;lido', 'Debe seleccionar un valor de la lista y no introducir un dato err&oacute;neo.');
                                ...
                                new Ext.form.ComboBox({
                                    ...
                                    listeners: {
                                        'blur': function () {
                                            ...
                                            if (flag == -1 && Ext.getCmp('frm_center_idadvance').getValue() != '') {
                                                Ext.Msg.alert('Valor Inv&aacute;lido', 'Debe seleccionar un valor de la lista y no introducir un dato err&oacute;neo.');
                            ...
                            items: [new Ext.form.ComboBox({
                                ...
                                listeners: {
                                    ...
                                    'blur': function () {
                                        ...
                                        if (flag == -1 && Ext.getCmp('frm_province_idworker').getValue() != '') {
                                            Ext.Msg.alert('Valor Inv&aacute;lido', 'Debe seleccionar un valor de la lista y no introducir un dato err&oacute;neo.');
                                ...
                                new Ext.form.ComboBox({
                                    ...
                                    listeners: {
                                        'blur': function () {
                                            ...
                                            if (flag == -1 && Ext.getCmp('frm_person_idworker').getValue() != '') {
                                                Ext.Msg.alert('Valor Inv&aacute;lido', 'Debe seleccionar un valor de la lista y no introducir un dato err&oacute;neo.');
                                                Ext.getCmp('frm_person_idworker').reset();
                                                return false;
                                            }
                            ...
                            items: [new Ext.form.ComboBox({
                                ...
                                listeners: {
                                    ...
                                    'blur': function () {
                                        ...
                                        if (flag == -1 && Ext.getCmp('frm_transport_idexit').getValue() != '') {
                                            Ext.Msg.alert('Valor Inv&aacute;lido', 'Debe seleccionar un valor de la lista y no introducir un dato err&oacute;neo.');
                                ...
                                listeners: {
                                    'blur': function () {
                                        ...
                                        if (flag == -1 && Ext.getCmp('frm_province_idfrom').getValue() != '') {
                                            Ext.Msg.alert('Valor Inv&aacute;lido', 'Debe seleccionar un valor de la lista y no introducir un dato err&oacute;neo.');
                                ...
                                listeners: {
                                    ...
                                    'blur': function () {
                                        ...
                                        if (flag == -1 && Ext.getCmp('frm_province_idto').getValue() != '') {
                                            Ext.Msg.alert('Valor Inv&aacute;lido', 'Debe seleccionar un valor de la lista y no introducir un dato err&oacute;neo.');
                                            Ext.getCmp('frm_province_idto').reset();
                                            return false;
                                        }
                            ...
                            items: [new Ext.form.ComboBox({
                                ...
                                listeners: {
                                    'select': function () {
                                        ...
                                        if (id == 0) {
                                            Ext.getCmp('frm_transport_return_itinerary').getEl().up('.x-form-item').setDisplayed(true);
                                    ...
                                    'blur': function () {
                                        ...
                                        if (flag == -1 && Ext.getCmp('frm_transport_idreturn').getValue() != '') {
                                            Ext.Msg.alert('Valor Inv&aacute;lido', 'Debe seleccionar un valor de la lista y no introducir un dato err&oacute;neo.');
                                ...
                                listeners: {
                                    'blur': function () {
                                        ...
                                        if (flag == -1 && Ext.getCmp('frm_province_idfrom_return').getValue() != '') {
                                            Ext.Msg.alert('Valor Inv&aacute;lido', 'Debe seleccionar un valor de la lista y no introducir un dato err&oacute;neo.');
                                ...
                                listeners: {
                                    'blur': function () {
                                        ...
                                        if (flag == -1 && Ext.getCmp('frm_province_idto_return').getValue() != '') {
                                            Ext.Msg.alert('Valor Inv&aacute;lido', 'Debe seleccionar un valor de la lista y no introducir un dato err&oacute;neo.');
                                ...
                                new Ext.form.ComboBox({
                                    ...
                                    listeners: {
                                        'blur': function () {
                                            ...
                                            if (flag == -1 && Ext.getCmp('frm_province_idlodging').getValue() != '') {
                                                Ext.Msg.alert('Valor Inv&aacute;lido', 'Debe seleccionar un valor de la lista y no introducir un dato err&oacute;neo.');
                                ...
                                new Ext.form.ComboBox({
                                    ...
                                    listeners: {
                                        'blur': function () {
                                            ...
                                            if (flag == -1 && Ext.getCmp('frm_transport_idlodging').getValue() != '') {
                                                Ext.Msg.alert('Valor Inv&aacute;lido', 'Debe seleccionar un valor de la lista y no introducir un dato err&oacute;neo.');
                                ...
                                new Ext.form.ComboBox({
                                    ...
                                    listeners: {
                                        'blur': function () {
                                            ...
                                            if (flag == -1 && Ext.getCmp('frm_transport_idreturnlodging').getValue() != '') {
                                                Ext.Msg.alert('Valor Inv&aacute;lido', 'Debe seleccionar un valor de la lista y no introducir un dato err&oacute;neo.');
