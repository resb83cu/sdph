...
//                return false;
//            }
            Control.filterForm.getForm().getEl().dom.action = baseUrl + 'index.php/accounting/accounting_controlexport/reportControlPdf/';
     ...
     */
    Control.filterForm.render(Ext.get('control_pdf_grid'));
