...
Ext.onReady(function () {
    ...
    Requests.dataProxyreportInternalLodging = new Ext.data.HttpProxy({
        url: baseUrl + 'index.php/report/reports/reportInternalLodging/true/no/',     //ojo hay que obligado pasarle true
        method: 'POST'
    });
        ...
        tbar: [{
            ...
            handler: function () {
                if (dataStorereportInternalLodging.getCount() > 0) {
                    ...
                    Requests.filterForm.getForm().getEl().dom.action = baseUrl + 'index.php/report/reports/reportInternalLodging/true/si/';
                    ...
                    //Requests.filterForm.getForm().submit({url : baseUrl+'index.php/report/reports/reportInternalLodging/false/si/' });
                    //exportarPDF();
                } else {
            ...
            handler: function () {
                //if (dataStorereportInternalLodging.getCount()>0 ){
                Requests.filterForm.getForm().getEl().dom.action = baseUrl + 'index.php/report/reports/to_excel';
                Requests.filterForm.getForm().getEl().dom.method = 'POST';
                Requests.filterForm.getForm().submit();
                /*} else{
                 Ext.Msg.alert('Mensaje','No hay datos que exportar!');
...
/////////////////hasta aqui lo del gridpanel, ahora ponermos lo del formulario
    Requests.filterForm = new Ext.FormPanel({
        ...
        height: 250,
        width: 750,
        title: 'Par&aacute;metros del reporte general de hospedajes',
        items: [{
            layout: 'column',
            border: false,
            items: [{
                ...
                items: [new Ext.form.ComboBox({
                    ...
                    listeners: {
                        ...
                        'blur': function () {
                            ...
                            if (flag == -1 && Ext.getCmp('filter_province_idlodging').getValue() != "") {
                    ...
                    format: 'Y-m-d',
                    endDateField: 'filter_enddate' // id of the end date field
                }, {
                    xtype: 'datefield',
                    width: 200,
                    allowBlank: true,
                    ...
                    invalidText: "El formato correcto de la fecha es aaaa-mm-dd. Ejemplo: 2010-01-01",
                    format: 'Y-m-d',
                    startDateField: 'filter_begindate' // id of the start date field
                }, new Ext.form.ComboBox({
                    store: ['Si', 'No'],
                    fieldLabel: 'Dieta Reforzada',
                    displayField: 'reinforce',
                    valueField: 'reinforce',
                    hiddenName: 'reinforce',
                    allowBlank: true,
                    readOnly: true,
                    typeAhead: true,
                    mode: 'local',
                ...
                items: [new Ext.form.ComboBox({
                    ...
                    listeners: {
                        ...
                        'blur': function () {
                            ...
                            if (flag == -1 && Ext.getCmp('filter_province_idworkers').getValue() != "") {
                                Ext.Msg.alert('Valor Inv&aacute;lido', 'Debe seleccionar un valor de la lista y no introducir un dato err&oacute;neo.');
                    ...
                    listeners: {
                        'blur': function () {
                            ...
                            if (flag == -1 && Ext.getCmp('filter_person_id').getValue() != "") {
                                Ext.Msg.alert('Valor Inv&aacute;lido', 'Debe seleccionar un valor de la lista y no introducir un dato err&oacute;neo.');
    ...
    Requests.filterForm.addButton({
        ...
        handler: function () {
            ...
            dataStorereportInternalLodging.load({params: {start: 0, limit: 15}});
    ...
    Requests.filterForm.addButton({
        ...
        handler: function () {
            ...
            reinforce = Requests.filterForm.findById('filter_reinforce').getValue();

            province_idlodging = Requests.filterForm.findById('filter_province_idlodging').getValue();
            chain_id = Requests.filterForm.findById('frm_chain_id').getValue();
