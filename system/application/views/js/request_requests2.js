...
var dataReaderPos = new Ext.data.JsonReader({
    root:'data'
},dataRecordPos);
        ...
        items: [{
            ...
            items:[{
                ...
                items: [/*new Ext.form.ComboBox({
	           			...
	           			fieldLabel: 'Persona que solicita',
	           			...
	           			triggerAction: 'all',
	           			disabled:true, 					
	           			emptyText: 'Seleccione la persona logueada...',
	           			selectOnFocus: true,
	           			width: '100%',
	                ...
	                }),*/	
                {
                    ...
                    listeners: {
                        ...
                        'beforerender': function(){
                            ...
                            if (session_rollId == 6 || session_rollId == 5 || session_personId == 24 || session_personId == 27 || session_personId == 514) {
                ...
                new Ext.form.ComboBox({
                    ...
                    valueNotFoundText: 'Seleccione una persona...',
                    selectOnFocus: false,
                    width: 200,
                    value: '',
